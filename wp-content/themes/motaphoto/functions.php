...
function enqueue_custom_styles() {
    ...
    wp_enqueue_style('custom-info-photo-css', get_template_directory_uri() . '/css/info-photo.css', array(), '1.0', 'all');
    wp_enqueue_style('lightbox-css', get_template_directory_uri() . '/css/lightbox.css', array(), '1.0', 'all');
...
function enqueue_custom_scripts() {
    ...
    wp_enqueue_script('lightbox-scripts', get_template_directory_uri() . '/js/lightbox.js', array('jquery'), '1.0', true);
...
// Ajout du fichier JS load-more
//function enqueue_infinite_pagination_js() {
    //wp_enqueue_script('load-more-photos', get_template_directory_uri() . '/js/load-more.js', array('jquery'), null, true);
    //wp_localize_script('load-more-photos', 'ajax_params', array('ajax_url' => admin_url('admin-ajax.php')));
////}
//add_action('wp_enqueue_scripts', 'enqueue_load_more_js');
