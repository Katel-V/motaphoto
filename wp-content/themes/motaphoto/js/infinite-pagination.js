        ...
        success: function (response) {
            if (response) {
                ...
                if (load) {
                    ...
                    let txt = '<div style="text-align:center;width:100%; color: #000;font-family: SpaceMono;font-size: 16px;"><p>Aucun résultat ne correspond aux filtres de recherche.<br>';
