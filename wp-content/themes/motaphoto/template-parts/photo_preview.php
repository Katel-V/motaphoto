            ...
            <div class="overlay">
                ...
                <div class="eye-icon">
                    <a href="<?php echo esc_url($post_url); ?>">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon_eye.webp" alt="voir la photo">
                    </a>
                </div>
                ...
                <?php if ($reference) : ?>
                    <div class="fullscreen-icon" data-full="<?php echo get_the_post_thumbnail_url() ?>" data-category="<?php echo esc_attr($categorie_name); ?>" data-reference="<?php echo esc_attr($reference); ?>">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon_fullscreen.webp" alt="plein écran">
                    </div>
                <?php endif; ?>
